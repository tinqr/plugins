...
description: Capture friction as methodology notes. Two modes -- explicit (provide description) and contextual (scan current conversation for corrections). Triggers on "/remember", "/remember [description]".
---
...
**START NOW.** Reference below defines the two modes.
