...
### Step 1: Read Maintenance Thresholds
...
|--------|--------------|----------------|
| **Task stack** | Read `ops/tasks.md` -- active priorities and open items | Top items, open count, any deadlines |
...
| **Sessions** | Check `ops/sessions/` for recent session files | Last session date |
...
### Step 3: Classify by Consequence Speed
...
|-------|---------|-----------|-------------------|
| **Session** | Inbox > threshold, orphan notes (any), dangling links (any), 10+ pending observations | Immediate -- these degrade work quality right now | Orphans are invisible to traversal. Dangling links confuse navigation. Inbox pressure means lost ideas. |
| **Multi-session** | Stale notes > 10, inbox items aging > 7 days | Soon -- these compound over days | Stale notes represent decaying knowledge. Aging inbox means capture is outpacing processing. |
