...
Append the new task as a checkbox item at the END of the Active section:
...
**Active** is ordered by priority. Position 1 is highest priority.

**Completed** is ordered by completion date (most recent first).

**Discoveries** is unordered. Items accumulate during work. The user converts them to Active tasks or discards them.
