...
For each note, run these 5 checks:
...
- Length is roughly 50-200 characters
...
- A note with no index mention is disconnected -- flag it
...
- A single dangling link = flag with the specific broken link identified
...
- `notes/[file].md` -- no description field
...
#### Broken Wiki Links
- `notes/[file].md` -- [[broken link]] does not resolve
